...
function AssignmentCard({ a, token, pdfBase }: { a: CabAssignment; token: string; pdfBase: string }) {
  ...
  return (
    <article className="rounded-2xl border border-border bg-card p-4 shadow-sm">
      ...
      {/* ВРЕМЕННО (2026-07): онлайн-сдача скрыта — задание можно посмотреть текстом и скачать PDF. */}
...
// ВРЕМЕННО (2026-07): ItemsEditor/ItemRow/groupByLabel (инлайн-ответы ученика с автосохранением)
// удалены вместе с онлайн-сдачей. Восстановить — из git-истории коммита скрытия.
