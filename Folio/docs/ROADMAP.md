...
> M7a (2026-06-13): общий движок (_shared/generate.ts) + folio-generate Edge Function + окно генерации в вебе с сохранением шаблона. Назначение ученику и доставка — следующий заход.
...
- [ ] Список домашек/шаблонов в админке репетитора
