...
### M4: Schedule
> M4 (2026-06-13): недельный календарь-сетка + занятия (solo/группа), drag-and-drop переноса, быстрое «состоялось» кнопкой ✓ на карточке. Месяц/день-вью, per-user TZ, триггеры биллинга/журнала при «состоялось» — позже.
